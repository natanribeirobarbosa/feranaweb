 ...
 /*Logo do whatsaap para colocar nos títulos*/
...
if (!!document.querySelector('article.artigos'))/*teste para saber se a página é uma pagina de artigos*/{
...
var titulos= new Object();
    ...
    /*função para criar numeros aleatórios e usar nos artigos relacionados*//*
function getRandom(min,max){
    var n1=Math.random() * (max-min)+min;
        return parseInt(n1) }
     
    document.querySelector(`div#artigos-c a:nth-of-type(1) h1`).innerHTML=whatsaap.nome[recomendacao[2]]
    document.querySelector(`div#artigos-c a:nth-of-type(1) h1`).href=whatsaap.link[recomendacao[2]]
    
    document.querySelector(`div#artigos-c a:nth-of-type(2) h1`).innerHTML=whatsaap.nome[recomendacao[1]]
    document.querySelector(`div#artigos-c a:nth-of-type(2) h1`).href=whatsaap.link[recomendacao[1]]

    document.querySelector(`div#artigos-c a:nth-of-type(3) h1`).innerHTML=whatsaap.nome[recomendacao[0]]
    document.querySelector(`div#artigos-c a:nth-of-type(3) h1`).href=whatsaap.link[recomendacao[0]]

    document.querySelector(`div#artigos-c a:nth-of-type(4) h1`).innerHTML=whatsaap.nome[recomendacao[3]]
    document.querySelector(`div#artigos-c a:nth-of-type(4) h1`).href=whatsaap.link[recomendacao[3]]
