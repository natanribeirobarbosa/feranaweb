...
var item1_1=window.document.getElementById('i1').innerText
var item2_1=window.document.getElementById('i21').innerText
var item3_1=window.document.getElementById('i3_1_1').innerText
var item3_2=window.document.getElementById('i3_1_2').innerText
...
switch (numerodoartigo) {
    ...
    window.document.getElementById('pg1').innerHTML=item1_1
    window.document.getElementById('pg2').innerHTML=item2_1
    window.document.getElementById('pg3').innerHTML=item3_1
    ...
    window.document.getElementById('pg1').innerHTML=item1_1
    window.document.getElementById('pg2').innerHTML=item2_1
    window.document.getElementById('pg3').innerHTML=item3_2
...
var titulos= new Object();
    ...
    let artigo1=document.querySelector('#lista2-1 li:nth-of-type(1) a').innerHTML
    let artigo2=document.querySelector('#lista2-1 li:nth-of-type(2) a').innerHTML
    let artigo3=document.querySelector('#lista2-1 li:nth-of-type(3) a').innerHTML
    let artigo4=document.querySelector('#lista2-1 li:nth-of-type(4) a').innerHTML
    let artigo5=document.querySelector('#lista2-1 li:nth-of-type(5) a').innerHTML
    let artigo6=document.querySelector('#lista2-1 li:nth-of-type(6) a').innerHTML
    let artigo7=document.querySelector('#lista2-1 li:nth-of-type(7) a').innerHTML
    let artigo8=document.querySelector('#lista2-1 li:nth-of-type(8) a').innerHTML
    let artigo9=document.querySelector('#lista2-1 li:nth-of-type(9) a').innerHTML

    let link1=document.querySelector('#lista2-1 li:nth-of-type(1) a').href
    let link2=document.querySelector('#lista2-1 li:nth-of-type(2) a').href
    let link3=document.querySelector('#lista2-1 li:nth-of-type(3) a').href
    let link4=document.querySelector('#lista2-1 li:nth-of-type(4) a').href
    let link5=document.querySelector('#lista2-1 li:nth-of-type(5) a').href
    let link6=document.querySelector('#lista2-1 li:nth-of-type(6) a').href
    let link7=document.querySelector('#lista2-1 li:nth-of-type(7) a').href
    let link8=document.querySelector('#lista2-1 li:nth-of-type(8) a').href
    let link9=document.querySelector('#lista2-1 li:nth-of-type(9) a').href
    ...
    var r1=parseInt(numerodecelulas*0.25)
    var r2=parseInt(numerodecelulas*0.50)
    var r3=parseInt(numerodecelulas*0.75)
    var r4=parseInt(numerodecelulas*1.00)
    ...
    const recomendacao=[getRandom(0,r1),getRandom(r1,r2),getRandom(r2,r3),getRandom(r3,r4)]
...
/*
    document.querySelector(`div#recomendados a:nth-of-type(1) article h1`).innerHTML=whatsaap.nome[recomendacao[2]]
    document.querySelector(`div#recomendados a:nth-of-type(1)`).href=whatsaap.link[recomendacao[2]]
    
    document.querySelector(`div#recomendados a:nth-of-type(2) article h1`).innerHTML=whatsaap.nome[recomendacao[1]]
    document.querySelector(`div#recomendados a:nth-of-type(2)`).href=whatsaap.link[recomendacao[1]]

    document.querySelector(`div#recomendados a:nth-of-type(3) article h1`).innerHTML=whatsaap.nome[recomendacao[0]]
    document.querySelector(`div#recomendados a:nth-of-type(3)`).href=whatsaap.link[recomendacao[0]]

    document.querySelector(`div#recomendados a:nth-of-type(4) article h1`).innerHTML=whatsaap.nome[recomendacao[3]]
    document.querySelector(`div#recomendados a:nth-of-type(4)`).href=whatsaap.link[recomendacao[3]]
